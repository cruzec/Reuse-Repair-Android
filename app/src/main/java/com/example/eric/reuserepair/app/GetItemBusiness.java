...
public class GetItemBusiness extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... urls) {
        ...
        String reuseAndRepairAPI = "http://web.engr.oregonstate.edu/~jenkinch/api.php/item-business";
        try {
