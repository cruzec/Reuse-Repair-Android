...
public class GetBusiness extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... urls) {
        ...
        String reuseAndRepairAPI = "http://web.engr.oregonstate.edu/~jenkinch/api.php/business";
        try {
